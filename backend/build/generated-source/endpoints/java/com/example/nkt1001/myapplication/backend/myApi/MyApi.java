 ...
 * on 2016-10-18 at 14:31:39 UTC 
 * Modify at your own risk.
 */

package com.example.nkt1001.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "obtainJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link ObtainJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public ObtainJoke obtainJoke() throws java.io.IOException {
    ObtainJoke result = new ObtainJoke();
    initialize(result);
    return result;
  }

  public class ObtainJoke extends MyApiRequest<com.example.nkt1001.myapplication.backend.myApi.model.Joke> {

    private static final String REST_PATH = "obtainJoke";

    /**
     * Create a request for the method "obtainJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link ObtainJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * ObtainJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected ObtainJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.nkt1001.myapplication.backend.myApi.model.Joke.class);
    }
    ...
    @Override
    public ObtainJoke setAlt(java.lang.String alt) {
      return (ObtainJoke) super.setAlt(alt);
    }

    @Override
    public ObtainJoke setFields(java.lang.String fields) {
      return (ObtainJoke) super.setFields(fields);
    }

    @Override
    public ObtainJoke setKey(java.lang.String key) {
      return (ObtainJoke) super.setKey(key);
    }

    @Override
    public ObtainJoke setOauthToken(java.lang.String oauthToken) {
      return (ObtainJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public ObtainJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ObtainJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ObtainJoke setQuotaUser(java.lang.String quotaUser) {
      return (ObtainJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public ObtainJoke setUserIp(java.lang.String userIp) {
      return (ObtainJoke) super.setUserIp(userIp);
    }

    @Override
    public ObtainJoke set(String parameterName, Object value) {
      return (ObtainJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.nkt1001.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.nkt1001.myapplication.backend.myApi.model.MyBean.class);
